...
>>> run('sepkjaer')
>>> run("sepkjaer2323123123123")
sepkjaer2323123123123
'sepkjaer2323123123123'
...
******************************
Log File --> /home/travis/build/sepandhaghighi/telecheck
>>> save_id([],0)
No Valid Username!!(Choose Better Keywords)
******************************
Total Valid Usernames : 0
